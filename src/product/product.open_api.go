...
// Base is common detail of products open api document component.
func (o *OpenAPIOperation) Base() {
	o.Tags = []string{"Product"}
	o.HeaderParams = []map[string]any{{"$ref": "#/components/parameters/headerParam.Accept-Language"}}
	o.Responses = map[string]map[string]any{
		"200": {
			"description": "Success",
			"content":     map[string]any{"application/json": &Product{}}, // will auto create schema $ref: '#/components/schemas/Product' if not exists
		},
...
// Get is detail of `GET /api/v3/products` open api document component.
func (o *OpenAPIOperation) Get() *OpenAPIOperation {
	...
	o.Description = "Use this method to get list of Product"
	o.QueryParams = []map[string]any{{"$ref": "#/components/parameters/queryParam.Any"}}
	o.Responses = map[string]map[string]any{
		"200": {
			"description": "Success",
			"content":     map[string]any{"application/json": &ProductList{}}, // will auto create schema $ref: '#/components/schemas/Product.List' if not exists
		},
		"400": app.OpenAPIError().BadRequest(),
		"401": app.OpenAPIError().Unauthorized(),
		"403": app.OpenAPIError().Forbidden(),
...
// GetByID is detail of `GET /api/v3/products/{id}` open api document component.
func (o *OpenAPIOperation) GetByID() *OpenAPIOperation {
	...
	o.Description = "Use this method to get Product by id"
	o.PathParams = []map[string]any{{"$ref": "#/components/parameters/pathParam.ID"}}
	return o
}

// Create is detail of `POST /api/v3/products` open api document component.
func (o *OpenAPIOperation) Create() *OpenAPIOperation {
	...
	o.Description = "Use this method to create Product"
	o.Body = map[string]any{"application/json": &ParamCreate{}}
	return o
}

// UpdateByID is detail of `PUT /api/v3/products/{id}` open api document component.
func (o *OpenAPIOperation) UpdateByID() *OpenAPIOperation {
	...
	o.Base()
	o.Summary = "Update Product By ID"
	o.Description = "Use this method to update Product by id"
	o.PathParams = []map[string]any{{"$ref": "#/components/parameters/pathParam.ID"}}
	o.Body = map[string]any{"application/json": &ParamUpdate{}}
	return o
}

// PartiallyUpdateByID is detail of `PATCH /api/v3/products/{id}` open api document component.
func (o *OpenAPIOperation) PartiallyUpdateByID() *OpenAPIOperation {
	...
	o.Base()
	o.Summary = "Partially Update Product By ID"
	o.Description = "Use this method to partially update Product by id"
	o.PathParams = []map[string]any{{"$ref": "#/components/parameters/pathParam.ID"}}
	o.Body = map[string]any{"application/json": &ParamPartiallyUpdate{}}
	return o
}

// DeleteByID is detail of `DELETE /api/v3/products/{id}` open api document component.
func (o *OpenAPIOperation) DeleteByID() *OpenAPIOperation {
	...
	o.Base()
	o.Summary = "Delete Product By ID"
	o.Description = "Use this method to delete Product by id"
	o.PathParams = []map[string]any{{"$ref": "#/components/parameters/pathParam.ID"}}
