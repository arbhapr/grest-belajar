...
// GetByID is the REST API handler for `GET /api/users/{id}`.
...
// Get is the REST API handler for `GET /api/users`.
...
// Create is the REST API handler for `POST /api/users`.
...
// UpdateByID is the REST API handler for `PUT /api/users/{id}`.
...
// PartiallyUpdateByID is the REST API handler for `PATCH /api/users/{id}`.
...
// DeleteByID is the REST API handler for `DELETE /api/users/{id}`.
