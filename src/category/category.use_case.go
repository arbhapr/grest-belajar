...
// UseCaseHandler provides a convenient interface for Category use case, use UseCase to access UseCaseHandler.
...
// GetByID returns the Category data for the specified ID.
func (u UseCaseHandler) GetByID(id string) (Category, error) {
	res := Category{}

	// check permission
	err := u.Ctx.ValidatePermission("categories.detail")
	if err != nil {
		return res, err
	}
...
// Get returns the list of Category data.
func (u UseCaseHandler) Get() (app.ListModel, error) {
	res := app.ListModel{}

	// check permission
	err := u.Ctx.ValidatePermission("categories.list")
	if err != nil {
		return res, err
	}
	// get from cache and return if exists
	...
	// find data
	data, err := app.Query().Find(tx, &Category{}, u.Query)
	if err != nil {
		return res, app.Error().New(http.StatusInternalServerError, err.Error())
	}
...
// Create creates a new data Category with specified parameters.
func (u UseCaseHandler) Create(p *ParamCreate) error {

	// check permission
	err := u.Ctx.ValidatePermission("categories.create")
	if err != nil {
		return err
	}
	...
	err = p.setDefaultValue(Category{})
	if err != nil {
		return err
	}
...
// UpdateByID updates the Category data for the specified ID with specified parameters.
func (u UseCaseHandler) UpdateByID(id string, p *ParamUpdate) error {

	// check permission
	err := u.Ctx.ValidatePermission("categories.edit")
	if err != nil {
		return err
	}
...
// PartiallyUpdateByID updates the Category data for the specified ID with specified parameters.
...
// DeleteByID deletes the Category data for the specified ID.
func (u UseCaseHandler) DeleteByID(id string, p *ParamDelete) error {

	// check permission
	err := u.Ctx.ValidatePermission("categories.delete")
	if err != nil {
		return err
	}
